...
- **3 × Servo Motors**
  ...
  - 1 servo for an additional mechanism
...
> **Note:** The final power distribution and voltage requirements should be verified before assembly to ensure that the batteries, BMS units, buck converter, ESP32-S3-CAM, sensors, and servos operate within their specified electrical limits.
